create view public.notification_items
...
revoke all on public.notification_items from anon, authenticated;
grant select on public.notification_items to authenticated;

comment on view public.notification_items is
  'Central de notificações unificada: lembretes vencendo/vencidos, orçamentos >=80%, documentos de veículo vencendo e recorrências pendentes de geração.';
